...
def _register_rule_modules(container: Container) -> None:
    ...
    growth（APC-T023）。Epic E03 规则域全部接入。
    """

    from .rule_engine.domains.growth import GrowthRuleModule
    ...
    # growth 域（APC-T023）：WHO 0-5 岁百分位 + 趋势提醒（who-0-5.yaml）。
    _register(rules_dir / "growth" / "who-0-5.yaml", GrowthRuleModule, "growth")
