...
## 项目身份
- 项目名：`debt-collection`（个人合法讨债助手 / 工厂陪练）
- 类型：`本地工具（待 SPEC 定，倾向 CLI/本地应用 + 本地存储）`
- 当前 Phase：`SPEC 完成，待 GATE-2 → BUILD`（活文档 KR-002-2）
- ⚠️ 红线：仅合法路径，绝不非法查他人财产/隐私，绝不施压催收（见 docs/DISCOVERY.md）
