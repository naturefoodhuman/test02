...
- `APC-T038/T039/T040`：camera_event/sensor_event SQLAlchemy repositories + DB smoke 已完成；真实 RTSP/ISAPI/Fregata/MQTT/VLM/device 验收仍待。
