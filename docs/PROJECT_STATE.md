...
**当前版本**：v1.4.16-feos-detector-evidence-graph
...
- FEOS-003~FEOS-026 已完成：核心领域模型、存储基础、Repository、Case 状态机、CaseService、基础 CLI、Facade、Workflow Guard、Detector scoring/service、Evidence framework/service/collectors、Case Graph builder/service。
- 当前 FEOS 已具备本地创建/查看 Case、Detector 决策、Evidence 采集保存与基础 Case Graph 构建能力；后续应继续执行 FEOS-027 Similarity Retrieval。
